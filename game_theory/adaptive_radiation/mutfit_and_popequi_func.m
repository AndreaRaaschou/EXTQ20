...
%system defined by parameters in main_eco_evo and piped into this function

%Note that this code is very much based (basically the same) on the the ecological time 
% scale main program that is used to study time series 
...
%     p.disp_mat=disp_mat; %Pipe the dispersal matrix into the ODE solver
